...
export type SectionStatus = "pending" | "active" | "sufficient" | "insufficient"
...
export const BLOG_TYPES: { id: BlogType; label: string; description: string }[] = [
  { id: "troubleshooting", label: "트러블 슈팅", description: "문제 해결 과정 기록" },
  { id: "design", label: "설계/구현", description: "기능 설계 및 구현 기록" },
  { id: "analysis", label: "지표 분석", description: "지표 분석 / 실험 결과 정리" },
  { id: "learning", label: "학습 정리", description: "논문 / 아티클 학습 정리" },
]
