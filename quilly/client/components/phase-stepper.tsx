          ...
          <div key={phase.id} className="flex items-center">
            <button
              ...
              className={cn(
                ...
                isCurrent && "bg-emerald-500/20 text-emerald-400 ring-1 ring-emerald-500/50",
            ...
            >
              <span
                className={cn(
                  ...
                  isCurrent && "bg-emerald-500/30 text-emerald-400 ring-1 ring-emerald-500",
            ...
            {index < PHASES.length - 1 && (
              <div className={cn("w-4 h-px mx-1", index < currentIndex ? "bg-emerald-500" : "bg-border")} />
            )}
          </div>
        )
      })}
