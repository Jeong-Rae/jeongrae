    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">AI 기반 기술 블로그 작성 도우미</p>
            </div>
          </div>
          <Button onClick={onCreateProject} className="bg-emerald-600 hover:bg-emerald-700 text-white">
        ...
        <div className="space-y-3">
          <h2 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">최근 작업</h2>
          {projects.length > 0 ? (
            ...
            <div className="text-center py-16 px-6 rounded-lg border border-dashed border-border">
              ...
              <p className="text-sm text-muted-foreground mb-4">첫 번째 Tech Blog 글을 작성해보세요.</p>
              <Button
